<template>
  <nav
    class="bg-slate-200 dark:bg-gray-900 sticky w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600"
  >
    <div
    ...
    >
      ...
      >
        <span
          ...
          >TO<span class="text-red-500">TOS</span></span
        >
      </RouterLink>
